...
Controller::Controller( IGpio& gpio )
    : m_model( gpio )
{
    ...
    m_model.m_zAxisMotor = std::make_unique<mgo::StepperMotor>( gpio, 8, 7, 0, 1'000, -0.001 );
    m_model.m_xAxisMotor = std::make_unique<mgo::StepperMotor>( gpio, 20, 21, 0, 800, 1.0 / 2'400.0 );
    m_model.m_rotaryEncoder = std::make_unique<mgo::RotaryEncoder>( gpio, 23, 24, 2000, 35.f/30.f );
}
